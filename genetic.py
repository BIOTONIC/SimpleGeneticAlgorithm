...
Test10-27         1D  http://web.wlu.ca/science/physcomp/ikotsireas/sga/of.txt
...
if __name__ == '__main__':
    ...
    # 'GramacyLee' 'Beale' 'GoldsteinPrice' 'Himmelblau' 'DeJong' 'Rosenbrock' 'Rastrigin' or 'Test10' to 'Test27'
    of = 'DeJong'
    n = param_dict[of][0]
